...
* to make all fractions reduced to their lowest terms. Warning: The
* canonical representation of 0 as a fraction is 0/1.
*/
...
.multiply(multiplier.numerator);
BigInteger resultDenominator = this.denominator
.multiply(multiplier.denominator);
...
BigInteger newmerator = this.numerator.multiply(NEGATIVE_ONE);
     new Fraction(newmerator, this denominator);
